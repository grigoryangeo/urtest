...
urlpatterns = patterns('bugtracker.views',
    url(r'^projects/show/(?P<project_id>\d+)$', 'project_detail', name="project_detail"),
    url(r'^projects/show/(?P<project_id>\d+)/testers$', 'project_detail_testers', name="project_detail_testers"),
    url(r'^projects/show/(?P<project_id>\d+)/bugs$', 'project_detail_bugs', name="project_detail_bugs"),
    url(r'^projects/enlist/(?P<project_id>\d+)$', 'project_add_tester', name="project_add_tester"),
